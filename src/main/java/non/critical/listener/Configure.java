...
public class Configure {
    ...
    //TODO - check how to get jira token like azure PAT
    /**
     * TOKEN:
     * for "Azure" should be after generating, example: "Basic OmluMzV3aGQzd3E3...."
     * for "Jira" should be after generating, example: "OmluMzV3aGQzd3E....." (without "Bearer")
     * TICKET_SYSTEM: examples: "Azure" or "Jira"
     */
    private static final String TICKET_SYSTEM = "Jira";
...
//    public static final String TOKEN = "Basic OmluMzV3aGQzd3E3bGFweGgzZXV2dmF6dDVjbGlod201cXR0emNhcnYyZWpiMzQzaTR5M2E=";
    ...
    public static String azure_organization = "itzikv3";
    public static String azure_project = "bug-listener";
    ...
    public void setBaseUrl() {
        if ("Azure".equals(TICKET_SYSTEM)) {
            this.baseUrl = "https://dev.azure.com/" + azure_organization + "/" + azure_project + "/_apis/wit/workitems/";
    ...
    public void setTicketSystem() {
        ...
        } else if ("Azure".equals(TICKET_SYSTEM)) {
